...
# (provider != Author) over the current branch, per .standards/docs/standards/ai_guidelines.md.
# Called by the pre-push hook; also runnable by hand. See .standards/docs/standards/codex_review.md.
set -u
